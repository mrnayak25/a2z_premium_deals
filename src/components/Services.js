...
const Services = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center py-8 px-4">
      {/* left side */}
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center text-center md:text-left space-y-5">
      ...
      <div className="w-full md:w-1/2 flex flex-col md:flex-row justify-center items-center space-y-10 md:space-y-0 md:space-x-10">
        <div className="space-y-4">
          <div className="w-full md:w-48 flex flex-col items-center bg-white text-center p-5 drop-shadow-2xl rounded-md">
