...
const Services = () => {
  return (
    <div className="m-auto flex flex-col md:flex-row justify-around items-center md:space-x-10 space-y-10 md:space-y-0 py-10">
    {/* right side */}
    <div className=" flex space-x-4 md:space-x-10 p-5">
    ...
    {/* left side */}
    <div className=" w-2/3 md:1/2 space-y-5">
